run_app:
	python3 ./Scripts/spacex_dash_app.py & sleep 30
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|DataScience_CapstoneProject_IBM\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|DataScience_CapstoneProject_IBM/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|DataScience_CapstoneProject_IBM/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|DataScience_CapstoneProject_IBM/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|DataScience_CapstoneProject_IBM/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|DataScience_CapstoneProject_IBM/assets|g' {} \;
